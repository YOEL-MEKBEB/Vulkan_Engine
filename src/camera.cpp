...
void Camera::update(){
  ...
  velocity.z = (state[SDL_SCANCODE_S] - state[SDL_SCANCODE_W]) * 0.1f;
  velocity.x = (state[SDL_SCANCODE_D] - state[SDL_SCANCODE_A]) * 0.1f;
  velocity.y = (state[SDL_SCANCODE_E] - state[SDL_SCANCODE_Q]) * 0.1f;

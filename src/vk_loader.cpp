        ...
        fastgltf::visitor {
            ...
            [&](fastgltf::sources::URI& filePath) {
                ...
                if (data) {
                    ...
                    newImage = engine->create_image(data, imagesize, VK_FORMAT_R8G8B8A8_UNORM, VK_IMAGE_USAGE_SAMPLED_BIT, VK_IMAGE_VIEW_TYPE_2D,true); // the last parameter determines whethere mipmaps get generated
            ...
            [&](fastgltf::sources::Vector& vector) {
                ...
                if (data) {
                    ...
                    newImage = engine->create_image(data, imagesize, VK_FORMAT_R8G8B8A8_UNORM, VK_IMAGE_USAGE_SAMPLED_BIT, VK_IMAGE_VIEW_TYPE_2D,true);
            ...
            [&](fastgltf::sources::BufferView& view) {
                ...
                std::visit(fastgltf::visitor { // We only care about VectorWithMime here, because we
                               ...
                               [](auto& arg) {},
                               [&](fastgltf::sources::Vector& vector) {
                                   unsigned char* data = stbi_load_from_memory(reinterpret_cast<const unsigned char*>(vector.bytes.data() + bufferView.byteOffset),
                                   ...
                                   if (data) {
                                       ...
                                       newImage = engine->create_image(data, imagesize, VK_FORMAT_R8G8B8A8_UNORM,
                                           VK_IMAGE_USAGE_SAMPLED_BIT, VK_IMAGE_VIEW_TYPE_2D,true);
...
std::optional<std::shared_ptr<LoadedGLTF>> loadGltf(VulkanEngine* engine, std::filesystem::path filePath){
    ...
    //Now we have to load everything in order. MeshNodes
    //depend on meshes, meshes depend on materials, and materials on textures.
    // loading order: images -> materials -> meshes -> nodes.
